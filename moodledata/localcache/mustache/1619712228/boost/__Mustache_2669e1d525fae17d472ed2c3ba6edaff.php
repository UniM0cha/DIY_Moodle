...
class __Mustache_2669e1d525fae17d472ed2c3ba6edaff extends Mustache_Template
{
...
';
        $buffer .= $indent . '                
';
        $buffer .= $indent . '                 <div class="contentHome__warp">
';
        $buffer .= $indent . '				<div>
';
        $buffer .= $indent . '                
...
';
        $buffer .= $indent . '                        document.write("<p class="contentHomeContent">블록코딩 + 파이썬 기반의 머신러닝<br>학습을 위한 도구 입니다.</p>");
';
        $buffer .= $indent . '                        
';
        $buffer .= $indent . '                        console.log(\'head html pathname: \' + window.location.pathname);
';
        $buffer .= $indent . '                    }
';
        $buffer .= $indent . '                </script>
