...
class __Mustache_b55e97cbfb3f568fd94dfc2d003610b5 extends Mustache_Template
{
...
';
        ...
        $buffer .= ' delete-->
';
        $buffer .= $indent . '            <span class="site-name d-none d-md-inline"></span>
';
        $buffer .= $indent . '        </a>
';
        $buffer .= $indent . '
