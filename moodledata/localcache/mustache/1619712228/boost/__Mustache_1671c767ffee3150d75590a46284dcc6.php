...
class __Mustache_1671c767ffee3150d75590a46284dcc6 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section0c44181620a201fb9e92f8113589faf0($context, $indent, $value);
        $buffer .= $indent . '    </ul>
';
        $buffer .= $indent . '</nav>
';
...
';
    ...
    private function sectionA43092a0653f08fb92b17952256b70f6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        <script>
            ...
            if(key == "mycourses"){
                console.log(\'head css mycourses: \' + window.location.pathname);
            }
        </script>
            <li>
...
';
                $buffer .= $indent . '           
';
                $buffer .= $indent . '            if(key == "mycourses"){
';
                $buffer .= $indent . '                console.log(\'head css mycourses: \' + window.location.pathname);
';
                $buffer .= $indent . '            }
';
                $buffer .= $indent . '        </script>
...
';
    ...
    private function section0c44181620a201fb9e92f8113589faf0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->sectionA43092a0653f08fb92b17952256b70f6($context, $indent, $value);
