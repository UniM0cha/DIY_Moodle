...
class __Mustache_bb2b0e5d4919d87c0e1d85122f61df25 extends Mustache_Template
{
...
';
        $buffer .= $indent . '                
';
        $buffer .= $indent . '                <p class="contentHomeContent">블록코딩 + 파이썬 기반의 머신러닝<br>학습을 위한 도구 입니다.
';
        $buffer .= $indent . '                </p>
';
        $buffer .= $indent . '				</div>
