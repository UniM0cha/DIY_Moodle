...
class __Mustache_ec5d71974c49ea695c07b07e494092f4 extends Mustache_Template
{
...
';
        $buffer .= $indent . '        var attr = document.getElementsByTagName(\'a\');
';
        $buffer .= $indent . '        
';
        $buffer .= $indent . '        while(attr.length){
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '            var target = target.hasAttribute(\'href\');
';
        $buffer .= $indent . '            if (target === false){
';
        $buffer .= $indent . '                document.write("<style>.list-group-item background: #C4DEFF;}</style>")
';
        $buffer .= $indent . '            }
';
        $buffer .= $indent . '        }
