    ...
    public function find_active_node() {
        if ($this->isactive) {
            ...
            foreach ($this->children as &$child) {
                ...
                if ($outcome !== false) {
                    return $outcome;  // thissssssssssssss course
                }
            }
        }
        return false;
...
class global_navigation extends navigation_node {
    ...
    public function add_course_essentials($coursenode, stdClass $course) {
        ...
        // DIY 2021.03.12 Lee Seong Ju
        // if ($navoptions->badges) {
        //     // $url = "http://diy.inhatc.ac.kr:50197/";
        //     $url = new moodle_url('/theme/DIY.html');
        //     $coursenode->add('DIY', $url,
        //             navigation_node::TYPE_SETTING, null, 'DIY',
        //             new pix_icon('i/badge', get_string('DIY', 'DIY')));
        // }
...
class flat_navigation extends navigation_node_collection {
    ...
    public function initialise() {
        ...
        if ($course->id > 1) {
            ...
            while (!empty($coursenode) && ($coursenode->type != $targettype)) { // defense code ////
            ...
            if ($coursenode && $coursenode->key != SITEID) {
                ...
                foreach ($coursenode->children as $child) {
                    if ($child->action) {
                        ...
                        $this->add($flat); // This /////////// 2021.03.12 Lee Seong Ju
                    }
                }
            }
