...
$numsections = optional_param('numsections', 3, PARAM_INT);        // Number of sections to insert.
...
if (isset($courseformatoptions['numsections']) && $increase !== null) {
    $desirednumsections = $courseformatoptions['numsections'] + 2;
...
echo "<script>console.log( 'PHP_Console: ' )";
echo "</script>";
if (isset($courseformatoptions['numsections']) && $increase !== null) {
    if ($increase) {
